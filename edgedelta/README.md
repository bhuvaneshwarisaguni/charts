...
![Version: 0.1.70-rc27](https://img.shields.io/badge/Version-0.1.70--rc27-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.1.70-rc27](https://img.shields.io/badge/AppVersion-v0.1.70--rc27-informational?style=flat-square)
...
| compactorProps.resources.limits.memory | string | `"2048Mi"` |  |
| compactorProps.resources.requests.cpu | string | `"200m"` |  |
| compactorProps.resources.requests.memory | string | `"256Mi"` |  |
